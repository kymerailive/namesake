...
| Bond UI | Bands + the deed ring. **Never raw integers.** The bands are the five above, and the Notice Board prints **six phrases** for them — session 11's four ruled ones kept word for word, plus *trusts you* and *will not forget*, which are the two distinctions the bands added and the pools could not express. |
